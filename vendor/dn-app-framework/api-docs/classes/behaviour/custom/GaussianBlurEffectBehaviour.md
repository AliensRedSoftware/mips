# GaussianBlurEffectBehaviour

- **class** `GaussianBlurEffectBehaviour` (`behaviour\custom\GaussianBlurEffectBehaviour`) **extends** [`EffectBehaviour`](https://github.com/jphp-compiler/develnext/blob/master/dn-app-framework/api-docs/classes/php/gui/framework/behaviour/custom/EffectBehaviour.md)
- **package** `framework`
- **source** `behaviour/custom/GaussianBlurEffectBehaviour.php`
