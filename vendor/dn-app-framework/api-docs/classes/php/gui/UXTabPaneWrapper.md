...
- **class** `UXTabPaneWrapper` (`php\gui\UXTabPaneWrapper`) **extends** [`UXNodeWrapper`](https://github.com/jphp-compiler/develnext/blob/master/dn-app-framework/api-docs/classes/php/gui/UXNodeWrapper.md)
- **source** `php/gui/UXTabPaneWrapper.php`
